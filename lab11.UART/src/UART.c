...
/* Output: none */
void
UART_OutChar(unsigned char data)
{
...
/* Output: none */
void
UART_OutString(unsigned char buffer[])
{
    int i;
...
void
UART_ConvertUDec(unsigned long n)
{
    unsigned long d;
    if (n >= 10000) {
...
/* Fixed format 1 digit, point, 3 digits, space, units, null termination */
void
UART_OutDistance(unsigned long n)
{
